...
{platform.architecture()[0]}\
    ...
    # will be generated by Nexus Mods staff when api key is requested
    application_slug: str = None  # FOR TESTING PURPOSES ONLY!!!
    ...
    def check_api_key(self):
        ...
        # self.premium = False  # FOR TESTING ONLY!!!
    ...
    def get_mod_translations(self, game_id: str, mod_id: int) -> dict[str, list[str]]:
        ...
        #     tag.text: parsed.find("a", {"class": f"sortme flag flag-{tag.text}"})[
        #         "href"
        #     ]
        #     for tag in translation_list.children
        #     if tag.text != "\n"
        # }
        # available_translations = dict(sorted(available_translations.items()))
        ...
        for tag in translation_list.children:
            ...
            #     available_translations[language].append(url)
            # else:
            #     available_translations[language] = [url]
