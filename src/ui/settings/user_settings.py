...
class UserSettings(QScrollArea):
    ...
    def __init__(self, app: MainApp):
        ...
        # Source
        provider_box = QGroupBox(self.loc.main.source)
        ...
        api_setup_button = QPushButton(self.mloc.start_api_setup)
        ...
        # Masterlist
        self.masterlist_box = QCheckBox(self.mloc.use_masterlist)
        ...
        open_masterlist_button = QPushButton(self.mloc.open_masterlist + "    ")
        ...
        open_masterlist_button.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        provider_flayout.addRow(self.masterlist_box, open_masterlist_button)

        # Author Blacklist
        author_blacklist_button = QPushButton(self.mloc.open_author_blacklist)
        ...
        instance_groupbox = QGroupBox(self.loc.main.modinstance)
        ...
        def on_instance_select(modinstance: str):
            ...
            mod_manager = SUPPORTED_MOD_MANAGERS[
        ...
        # Enabled File Types
        filetypes_groupbox = QGroupBox(self.mloc.enabled_file_types)
